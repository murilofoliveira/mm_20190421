...
namespace MindMiners.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<InterfaceSubtitle, RepositorySubtitle>();

            services.AddSingleton<IAppSubtitle, ApplicationSubtitle>();
        }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseMvc(routes =>
            {
                routes.MapRoute(
                    name: "default",
                    template: "{controller=Subtitle}/{action=Index}/{id?}");
            });
        }
    }
}
